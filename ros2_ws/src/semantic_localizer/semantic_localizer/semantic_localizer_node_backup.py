...
class SemanticLocalizerNode(Node):
    ...
    def __init__(self):
        ...
        self.declare_parameter('semantic_objects_filepath',
                               os.path.expanduser('/home/saim/dummybot-ros2-encoder/ros2_ws/maps/semantic_objects.geojson'))
        self.declare_parameter('route_graph_filepath',
                               os.path.expanduser('/home/saim/dummybot-ros2-encoder/ros2_ws/maps/route_graph_fiir.geojson'))
        self.declare_parameter('output_graph_filepath',
                               os.path.expanduser('/home/saim/dummybot-ros2-encoder/ros2_ws/maps/route_graph_fiir_semantic.geojson'))
        ...
        # (Nu mai e necesară — conversie inlinată în SemanticMapManager)
    ...
    def _save_maps_cb(self):
        ...
        # Save human-readable semantic graph (for debugging/article)
        self.map_manager.save_annotated_graph()

        # Save Nav2-compatible graph (flat metadata, no nested arrays)
